  ...
  )
{
  ...
  mFlashNvStorageVariableSize   = FixedPcdGet64 (PcdFlashNvStorageVariableSize);
  mFlashNvStorageFtwWorkingSize = FixedPcdGet64 (PcdFlashNvStorageFtwWorkingSize);
  mFlashNvStorageFtwSpareSize   = FixedPcdGet64 (PcdFlashNvStorageFtwSpareSize);
